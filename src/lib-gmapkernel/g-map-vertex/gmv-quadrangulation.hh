...
/**
 * Surcharge la méthode 'quadrangulateFace' de la classe CGMapGeneric pour
 * plonger le sommet qu'elle crée.
 *
 * Remarque: Si AInsertVertices vaut 'vrai', les sommets insérés sur les
 * arêtes de la face sont déjà plongés (car insertVertex est virtuelle).
 *
