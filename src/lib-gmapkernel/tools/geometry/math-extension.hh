 ...
 *
 * @param AValue Une valeur quelconque
 * @return la valeur A du segment [0,360[ telle que A = AAngle + 360*k.
 */
...
/**
 * Calcule le déterminant de la matrice 3*3 donnée par les sommets ALine1,
 * ALine2 et ALine3.
 *
 * @param ALine- Des sommets correspondant aux lignes de la matrice
 * @return Le déterminant de la matrice 3*3
 */
